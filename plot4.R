...
plot(dateTime, as.numeric(myRows$Global_active_power), type = 'l', ylab = 'Global Active Power',
     xlab = '')

plot(dateTime, as.numeric(myRows$Voltage), type = 'l', ylab = 'Voltage',
     xlab = 'datetime')
...
plot(dateTime, as.numeric(myRows$Global_reactive_power), type = 'l', ylab = 'Global_reactive_power',
     xlab = 'datetime')
